...
Como solución se creó un sistema de inventario donde se lleve las entradas de productos por sucursal, para que de esta manera se pueda acceder por medio de informes sobre el stock de la sucursal a buscar, de igual manera en la entidad Productos se encuentra un campo llamado stock donde se puede visualizar el stock general del producto. Esto permitirá llevar un mejor control y organización en la empresa.
...
# Sistema Web #
  ...
  6. Para levantar el servidor deberá ingresar el siguiente comando:
      ng serve
